...
// food list activity page that can  list out all food from firebase
...
public class FoodModelListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        options = new FirebaseRecyclerOptions.Builder<FoodModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("FoodLists"), FoodModel.class)
                        .build();
    ...
    private void bottomNavigation(){
        ...
        m_random_btn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                startActivity(new Intent(FoodModelListActivity.this, RandomFoodActivity.class));
            }
        });
        ...
        m_home_btn.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                startActivity(new Intent(FoodModelListActivity.this,MainActivity.class));
            }
        });
        ...
        m_profile_btn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent profileActivityIntent = new Intent(FoodModelListActivity.this, LogRegisterActivity.class);
        ...
        m_map_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(FoodModelListActivity.this,MapsActivity.class));
            }
        });
        ...
        m_food_list_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(FoodModelListActivity.this,FoodModelListActivity.class));
            }
        });
    }
}